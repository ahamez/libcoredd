...
{
  {
    dummy d;
    reset_used();
    ASSERT_TRUE(detail::apply_filters<dummy>()(d));

    reset_used();
    ASSERT_TRUE((detail::apply_filters<dummy, true_filter_1>()(d)));
    ASSERT_TRUE((true_filter_1::used));

    reset_used();
    ASSERT_TRUE((detail::apply_filters<dummy, true_filter_1, true_filter_2>()(d)));
    ASSERT_TRUE((true_filter_1::used));
    ASSERT_TRUE((true_filter_2::used));

    reset_used();
    ASSERT_FALSE((detail::apply_filters<dummy, false_filter_1>()(d)));
    ASSERT_TRUE((false_filter_1::used));

    reset_used();
    ASSERT_FALSE((detail::apply_filters<dummy, false_filter_1, false_filter_2>()(d)));
    ASSERT_TRUE((false_filter_1::used));
    ASSERT_FALSE((false_filter_2::used));

    reset_used();
    ASSERT_FALSE((detail::apply_filters<dummy, false_filter_1, true_filter_1>()(d)));
    ASSERT_TRUE((false_filter_1::used));
    ASSERT_FALSE((true_filter_1::used));

    reset_used();
    ASSERT_FALSE((detail::apply_filters<dummy, true_filter_1, false_filter_1, true_filter_2>()(d)));
    ASSERT_TRUE((true_filter_1::used));
    ASSERT_TRUE((false_filter_1::used));
